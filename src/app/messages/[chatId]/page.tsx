  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-blue-50 flex flex-col relative">
        ...
        <div className="container mx-auto w-full max-w-[1400px] xl:max-w-[1600px] px-4 mt-4 flex items-center justify-between">
        ...
        <main className="h-[calc(100vh-6rem)] flex container mx-auto px-2 sm:px-6 py-4 flex-col lg:flex-row gap-4 lg:gap-6 w-full max-w-[1400px] xl:max-w-[1600px] transition-all">          <ConversationList
